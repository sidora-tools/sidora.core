...
Only one specific account has the right read permissions to access the Pandora database directly. Please see the relevant archaeogenetics-only page on the EVA Kbase for the details.
